...
*/
$( function() {
        var endDate = "December  28, 2020 15:03:25";
        ...
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.days, 3) + " <span>日</span></div><div>" + this.leadingZeros(data.hours, 2) + " <span>小时</span></div><div>" + this.leadingZeros(data.min, 2) + " <span>分钟</span></div><div>" + this.leadingZeros(data.sec, 2) + " <span>秒</span></div>");
          }
        });
